# Funcionamiento General de Aplicativo Web para el Manejo de Finanzas Personales

## 1) Objetivo de la plataforma

Aplicativo Web para el Manejo de Finanzas Personales es un dashboard financiero web para:
